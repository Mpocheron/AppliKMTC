 ...
 */
final class Version20240408140126 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE casier (id INT AUTO_INCREMENT NOT NULL, le_modele_id INT DEFAULT NULL, le_relais_id INT NOT NULL, utilise TINYINT(1) DEFAULT 0 NOT NULL, INDEX IDX_3FDF285750CA3FD (le_modele_id), INDEX IDX_3FDF2858259B9D7 (le_relais_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, le_user_id INT DEFAULT NULL, adresse_expedition_id INT DEFAULT NULL, adresse_destination_id INT DEFAULT NULL, adresse_facturation_id INT DEFAULT NULL, le_casier_id INT DEFAULT NULL, hauteur INT NOT NULL, largeur INT NOT NULL, longueur INT NOT NULL, poids INT NOT NULL, INDEX IDX_6EEAA67D88A1A5E2 (le_user_id), INDEX IDX_6EEAA67D4AE9938B (adresse_expedition_id), INDEX IDX_6EEAA67D11481E0 (adresse_destination_id), INDEX IDX_6EEAA67D5BBD1224 (adresse_facturation_id), UNIQUE INDEX UNIQ_6EEAA67DBD210531 (le_casier_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(45) NOT NULL, prenom VARCHAR(45) NOT NULL, telephone VARCHAR(10) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE casier ADD CONSTRAINT FK_3FDF285750CA3FD FOREIGN KEY (le_modele_id) REFERENCES modele (id)');
